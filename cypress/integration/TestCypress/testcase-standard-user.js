describe('testcase ke1', () => {
  ...
  //Chechout Information
    ...
    it('Chosee Product by name', () =>  {
        ...
        //add 2 product berdasarkan id button
        // cy.get('.inventory_container').within(() => {
        //     cy.get('.inventory_item_description').find('#add-to-cart-sauce-labs-bolt-t-shirt').click()
        //     cy.get('.inventory_item_description').find('#add-to-cart-sauce-labs-backpack').click()
        // })
